...
# Questão 6
conta = ContaBancaria("kamily Lima", 2500)
print(conta.titular)
...
cliente1 = ClienteBanco("Josiel Eduardo", 50, "Av. Paulista, 1000", "11987654321", "Josiel.edu@example.com")
cliente2 = ClienteBanco("Carlos Rocha", 35, "Rua das Flores, 200", "21987654321", "Carlos.rocha@example.com")
cliente3 = ClienteBanco("Ronaldo Andrade", 29, "Praça da Sé, 300", "31987654321", "lucas.andrade@example.com")

cliente = ClienteBanco("kamily Lima", 29, "Rua das Palmeiras, 400", "41987654321", "kamily.lima@example.com")
